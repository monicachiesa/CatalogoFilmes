...
function Home() {
    ...
    useEffect(() => {
        let isActive = true;
        const ac = new AbortController(); //se mudar de tela, aborta
        ...
        async function getMovies() {
            ...
            if (isActive) {
                ...
                setBannerMovie(nowData.data.results[randomBanner(nowData.data.results)]) //gera um aleatório
